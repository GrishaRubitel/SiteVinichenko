...
let patchBut = document.getElementById("showReadme");

setInterval(function() {
    patchBut.style.boxShadow = "#ff5779 0px 0px 10px 5px";
    setTimeout(function() {
        patchBut.style.boxShadow = "transparent 0px 0px 10px 5px";
    }, 2000);
}, 4000);

patchBut.addEventListener("mouseover", function() {
    document.getElementById("readmeText").style.opacity = "1";
});

patchBut.addEventListener("mouseout", function() {
    document.getElementById("readmeText").style.opacity = "0";
});